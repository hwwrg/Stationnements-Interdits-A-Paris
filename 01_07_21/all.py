...
b = tk.Button(fenetre , text = 'Google Maps' , bg = 'ivory' )
b.place(x = 800 , y = 200)
...
regCom.place(x = 500 , y = 70)
regCom.current()

# créer un Bouton pour envoyer les filtres et activer la fonction

mapBou = tk.Button(fenetre, text = 'Afficher' , bg = 'ivory') # , command = getFiltres)
mapBou.place(x = 800, y = 70)
...
print("Stationnement les plus courts :", df_Q1_Court)

# le moins

df_Q1_Long = df_duree_sum.sort_values(by = 'Duree_Sum', ascending = False)
print("Stationnement les plus longs :", df_Q1_Long)
...
df = pandas.read_csv("C:/Users/Briche/Documents/GRETA_2021/projet_stationnement_paris/stationnements.txt" , sep = '\t', header = 0)
...
# faire un code if pour l'affichage